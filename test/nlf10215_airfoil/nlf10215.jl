...
begin
    ...
    @info "Running NLF(1)-0215, AR$AR, Re $Re, Mach 0 test case"
    ...
    set_airfoils!(wng, nlf10215, nlf10215)

    acft = Aircraft(wng; Sref = AR, bref = AR, cref = 1.0)


    soln, forces = viscous_solution(acft; α = 18.0)

    @show forces["total"]


    grid = vtk_grid("nlf(1)0215", acft)
